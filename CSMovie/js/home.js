...
function loadUserData() {
  const savedData = localStorage.getItem('CampSawiFlix_user_data');
  if (savedData) {
...
function saveUserData() {
  localStorage.setItem('CampSawiFlix_user_data', JSON.stringify(userData));
}
...
function showWelcomeMessage() {
  ...
  welcomeMsg.innerHTML = `
    ...
    Welcome to CampSawiFlix, ${userData.name}! Enjoy unlimited streaming!
  `;
...
function initVisitorTracking() {
  ...
  const savedStats = localStorage.getItem('CampSawiFlix_visitor_stats');
  if (savedStats) {
...
function saveVisitorStats() {
  ...
  localStorage.setItem('CampSawiFlix_visitor_stats', JSON.stringify(statsToSave));
}
